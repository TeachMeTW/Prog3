...
int safeSendto(int socketNum, void * buf, int len, int flags, struct sockaddr *srcAddr, int addrLen)
{
	...
	// // Debug print to verify if sendtoErr is being used
	// #ifdef __LIBCPE464_
	// printf("DEBUG: In safeSendto, sendto is defined as sendtoErr\n");
	// #else
	// printf("DEBUG: In safeSendto, using regular sendto\n");
	// #endif
